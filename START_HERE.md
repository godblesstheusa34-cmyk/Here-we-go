...
Keep Java 17 / Gradle 8.10.2 / AGP 8.7.3 / SDK 35 unless a specific verified issue requires a
...
ran on my phone unless it did. Use the workflow run's commit identifier to select the correct
download.
